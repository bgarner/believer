      ...
      <View style={{flex: 1}}>
        <View style={{flex: 8}}>
          <View style={{flex: 1}}>
            ...
            <View style={{flex: 0.5, flexDirection: 'row', paddingLeft: 20, paddingTop: 5}}>
            ...
            <View style={{flex: 6}}>
              ...
              <View
                style={{flex: 1.5, justifyContent: 'flex-start', overflow: 'scroll', paddingBottom: 10}}>
        ...
        <View style={{flex: 1, flexDirection: 'row', justifyContent: 'space-around'}}>
          <Button
            ...
            onPress={() => {
              Linking.openURL(this.state.message.action_url)
            }}
            textStyle={{
              fontSize: 14,
              fontWeight: 'bold',
